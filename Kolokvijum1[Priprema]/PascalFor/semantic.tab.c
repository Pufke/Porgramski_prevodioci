...
#line 88 "semantic.tab.c" /* yacc.c:339  */
...
{
       0,    55,    55,    63,    64,    69,    68,    88,    90,   102,
     105,   107,   111,   123,   125,   129,   130,   131,   132,   133,
     137,   154,   158,   170,   171,   179,   180,   186,   187,   192,
     195,   201,   200,   218,   220,   230,   231,   235,   239,   247,
     257
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_RBRACKET", "_ASSIGN", "_SEMICOLON", "_AROP", "_RELOP", "_DO",
  "_DOWNTO", "_FOR", "ONLY_IF", "$accept", "program", "function_list",
  "function", "$@1", "parameter", "body", "variable_list", "variable",
  "statement_list", "statement", "for_statement", "compound_statement",
...
{
      -2,    10,    39,    -2,   -51,   -51,   -51,   -51,    15,    40,
      44,    42,   -51,    43,   -51,   -51,    49,    47,   -51,    -1,
      45,    46,    25,    48,   -51,   -51,    50,   -51,   -51,   -51,
     -51,   -51,    53,   -51,   -51,    38,    51,   -51,   -51,    38,
     -51,    -7,   -51,   -51,   -51,    38,     9,    52,    24,    21,
      54,    57,     7,   -51,    38,    26,   -51,    41,   -51,    38,
      24,    38,   -51,   -51,   -51,    55,    56,   -51,    56,    58,
      41,   -51,    59,    24,   -51
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      16,    17,    35,    18,    12,     0,    26,    29,    30,     0,
      40,     0,    23,    25,    27,     0,     0,     0,     0,     0,
       0,     0,     0,    39,     0,     0,    21,     0,    36,     0,
       0,    33,    28,    24,    22,     0,    38,    37,    34,     0,
       0,    32,     0,     0,    20
};
...
{
     -51,   -51,   -51,    60,   -51,   -51,   -51,   -51,   -51,    35,
     -46,   -51,   -51,   -51,   -35,    14,   -50,   -51,   -51,   -51,
     -51,   -51,   -51,   -51
};
...
{
      49,     1,    58,    21,    52,    22,    23,    65,    53,    54,
      55,    24,    25,    21,    67,    22,    23,     5,    62,    26,
      72,    24,    56,    54,    66,     9,    68,    74,    21,    26,
      22,    23,    36,    37,    38,    39,    24,    54,    59,     6,
      40,    64,    54,    10,    26,    36,    37,    38,    39,    37,
      38,    12,    17,    13,    20,    14,    35,    47,    48,    46,
      34,   -31,    45,     7,     0,    60,    57,    61,    63,    71,
       0,     0,    54,     0,    70,     0,     0,    73
};

static const yytype_int8 yycheck[] =
{
      35,     3,    48,     4,    39,     6,     7,    57,    15,    16,
      45,    12,    13,     4,    60,     6,     7,     7,    11,    20,
      70,    12,    13,    16,    59,    10,    61,    73,     4,    20,
       6,     7,     7,     8,     9,    10,    12,    16,    17,     0,
      15,    15,    16,     3,    20,     7,     8,     9,    10,     8,
       9,     7,     3,    11,     7,    12,    10,     7,     5,    24,
      15,    10,    14,     3,    -1,    11,    14,    10,    54,    11,
      -1,    -1,    16,    -1,    19,    -1,    -1,    18
};
...
static const yytype_uint8 yystos[] =
{
       ...
       3,    27,     7,    11,    12,    28,    29,     3,    30,    31,
       7,     4,     6,     7,    12,    13,    20,    32,    33,    34,
      35,    42,    43,    45,    15,    10,     7,     8,     9,    10,
      15,    36,    37,    38,    39,    14,    31,     7,     5,    36,
      44,    40,    36,    15,    16,    36,    13,    14,    32,    17,
      11,    10,    11,    37,    15,    38,    36,    32,    36,    41,
      19,    11,    38,    18,    32
};
...
#line 138 "semantic.y" /* yacc.c:1646  */
    {
	int indexID = lookup_symbol((yyvsp[-6].s), VAR|PAR);
	//Da li je for_variable prethodno definisan
	if(indexID == -1){
	  err("for variabla/parameta mora biti prethodno definisan! ");
        }else{//da li su init_constant i final_constant tipovi kao i for_variable
	   if((get_type(indexID) != get_type((yyvsp[-4].i))) || (get_type(indexID) != get_type((yyvsp[-2].i)))){
	   	err("nit_constant i final_constant nisu isti tipovi kao i for_variable!");
	   }
	}
  }
