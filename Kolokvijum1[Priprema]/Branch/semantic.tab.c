...
{
       0,    55,    55,    63,    64,    69,    68,    85,    87,    96,
      99,   101,   105,   114,   116,   120,   121,   122,   123,   124,
     128,   143,   147,   159,   160,   168,   169,   175,   176,   181,
     184,   190,   189,   207,   209,   219,   220,   224,   228,   236
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_RBRACKET", "_ASSIGN", "_SEMICOLON", "_AROP", "_RELOP", "_BRANCH",
  "_FIRST", "_SECOND", "_THIRD", "_ZAREZ", "ONLY_IF", "$accept", "program",
  "function_list", "function", "$@1", "parameter", "body", "variable_list",
  "variable", "statement_list", "statement", "branch_statement",
...
{
       0,    16,    25,     0,   -61,   -61,   -61,   -61,    20,    34,
      38,    40,   -61,    37,   -61,   -61,    49,    46,   -61,     2,
      41,    44,     9,    43,   -61,   -61,    45,   -61,   -61,   -61,
     -61,   -61,    53,   -61,   -61,     9,    50,   -61,   -61,     9,
       6,   -61,   -61,   -61,     9,    28,    52,    32,    11,    51,
      54,    -9,   -61,     9,    27,   -61,    48,   -61,     9,    32,
       9,   -61,   -61,   -61,    39,    55,   -61,    55,    56,    47,
     -61,    39,    57,    39,    59,    42,    32,    58,    32,    60,
      32,   -61
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      16,    17,    35,    18,    12,     0,    26,    29,    30,     0,
       ...
       0,     0,    39,     0,     0,    21,     0,    36,     0,     0,
      33,    28,    24,    22,     0,    38,    37,    34,     0,     0,
...
{
      57,    48,    61,     1,    69,    51,    21,    53,    22,    23,
      54,    72,    66,    74,    24,    25,    36,    37,    38,    39,
      26,    52,    53,     5,    65,     6,    67,    53,    58,    77,
       9,    79,    21,    81,    22,    23,    21,    10,    22,    23,
      24,    55,    63,    53,    24,    12,    26,    37,    38,    14,
      26,    13,    17,    20,    35,    46,    34,    44,    47,    56,
     -31,    76,    59,    64,    60,     7,    62,    70,     0,    71,
      75,    53,     0,     0,     0,     0,     0,     0,    78,    73,
       0,    80,     0,     0,     0,    45
};

static const yytype_int8 yycheck[] =
{
      47,    35,    11,     3,    64,    39,     4,    16,     6,     7,
      44,    71,    59,    73,    12,    13,     7,     8,     9,    10,
      18,    15,    16,     7,    58,     0,    60,    16,    17,    76,
      10,    78,     4,    80,     6,     7,     4,     3,     6,     7,
      12,    13,    15,    16,    12,     7,    18,     8,     9,    12,
      18,    11,     3,     7,    10,    10,    15,    14,     5,     7,
      10,    19,    11,    15,    10,     3,    53,    11,    -1,    22,
      11,    16,    -1,    -1,    -1,    -1,    -1,    -1,    20,    22,
      -1,    21,    -1,    -1,    -1,    24
};
...
static const yytype_uint8 yystos[] =
{
       ...
       7,     4,     6,     7,    12,    13,    18,    34,    35,    36,
      37,    44,    45,    47,    15,    10,     7,     8,     9,    10,
      38,    39,    40,    41,    14,    33,    10,     5,    38,    46,
      42,    38,    15,    16,    38,    13,     7,    34,    17,    11,
      10,    11,    39,    15,    15,    38,    34,    38,    43,    40,
      11,    22,    40,    22,    40,    11,    19,    34,    20,    34,
      21,    34
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      35,    36,    37,    38,    38,    39,    39,    39,    39,    40,
      40,    42,    41,    43,    43,    44,    44,    45,    46,    47
};
...
#line 128 "semantic.y" /* yacc.c:1646  */
    {
	int indxID = lookup_symbol((yyvsp[-13].s) , VAR|PAR);
	...
	if(indxID == -1){
	  err("var prethodno mora biti definisan!");
		...
		if((get_type(indxID) != get_type((yyvsp[-11].i))) || (get_type(indxID) != get_type((yyvsp[-9].i))) || (get_type(indxID) != get_type((yyvsp[-7].i))))
...
#line 243 "semantic.y" /* yacc.c:1906  */
