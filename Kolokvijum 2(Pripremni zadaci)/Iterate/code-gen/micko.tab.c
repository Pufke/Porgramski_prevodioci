...
{
       0,    60,    60,    67,    69,    73,    81,    82,    87,    86,
     112,   114,   124,   123,   132,   134,   138,   147,   149,   153,
     154,   155,   156,   157,   161,   173,   161,   204,   208,   221,
     223,   242,   244,   251,   257,   262,   265,   271,   270,   290,
     292,   304,   307,   313,   318,   312,   331,   341
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_RBRACKET", "_ASSIGN", "_SEMICOLON", "_AROP", "_RELOP", "_ITERATE",
  "_TO", "ONLY_IF", "$accept", "program", "global_list", "global_var",
  "function_list", "function", "$@1", "parameter", "body", "$@2",
  "variable_list", "variable", "statement_list", "statement",
  "iterate_statement", "@3", "$@4", "compound_statement",
...
{
     -60,     3,    13,   -60,    26,   -60,    17,   -60,    24,    38,
     -60,   -60,    37,   -60,    45,    42,    39,   -60,    40,   -60,
     -60,    48,    46,   -60,   -60,    41,     1,   -60,    44,    34,
      43,   -60,   -60,    51,   -60,   -60,   -60,   -60,   -60,    50,
     -60,   -60,    49,   -60,   -60,    34,    -4,   -60,   -60,   -60,
      34,    18,   -60,    28,    34,    52,    -7,   -60,    34,     2,
     -60,    20,   -60,    21,   -60,    34,   -60,   -60,   -60,    47,
      34,    53,    54,    56,    20,    54,    28,   -60,   -60,   -60,
      28,   -60
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    17,    13,     0,    18,    23,    19,    20,    21,    41,
      22,    43,    32,    35,    36,     0,     0,    29,    31,    33,
       0,     0,    24,     0,     0,     0,     0,    47,     0,     0,
      27,     0,    42,     0,    44,    39,    34,    30,    28,     0,
       0,     0,    40,     0,     0,    46,     0,    38,    25,    45,
       0,    26
};
...
static const yytype_int8 yydefgoto[] =
{
      ...
      21,    24,    26,    34,    35,    61,    80,    36,    37,    46,
      47,    48,    49,    55,    73,    38,    39,    54,    71,    64,
      40
};
...
{
      62,    56,    69,     3,    66,    28,    59,    29,    30,    58,
      63,    57,    58,    31,    32,    78,     4,    68,    58,    33,
       9,    72,    28,    79,    29,    30,    75,    81,    43,    44,
      31,    60,    28,     8,    29,    30,    33,    58,    70,    11,
      31,    42,    43,    44,    45,    13,    33,    14,    15,    17,
      18,    22,    19,    25,    41,    53,    27,    50,    52,   -37,
      51,    10,    65,    67,    76,     0,    74,    77,     0,     0,
      58
};

static const yytype_int8 yycheck[] =
{
      53,    45,    61,     0,    11,     4,    50,     6,     7,    16,
      54,    15,    16,    12,    13,    74,     3,    15,    16,    18,
       3,    65,     4,    76,     6,     7,    70,    80,     8,     9,
      12,    13,     4,     7,     6,     7,    18,    16,    17,    15,
      12,     7,     8,     9,    10,     7,    18,    10,     3,     7,
      11,     3,    12,     7,    10,     5,    15,    14,     7,    10,
      31,     6,    10,    58,    11,    -1,    19,    11,    -1,    -1,
      16
};
...
{
       0,    22,    23,     0,     3,    24,    25,    26,     7,     3,
      26,    15,    27,     7,    10,     3,    28,     7,    11,    12,
      29,    31,     3,    30,    32,     7,    33,    15,     4,     6,
       7,    12,    13,    18,    34,    35,    38,    39,    46,    47,
      51,    10,     7,     8,     9,    10,    40,    41,    42,    43,
      14,    33,     7,     5,    48,    44,    40,    15,    16,    40,
      13,    36,    34,    40,    50,    10,    11,    41,    15,    42,
      17,    49,    40,    45,    19,    40,    11,    11,    42,    34,
      37,    34
};
...
{
       0,    21,    22,    23,    23,    24,    25,    25,    27,    26,
      28,    28,    30,    29,    31,    31,    32,    33,    33,    34,
      34,    34,    34,    34,    36,    37,    35,    38,    39,    40,
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 61 "micko.y" /* yacc.c:1646  */
    {  
        if(lookup_symbol("main", FUN) == NO_INDEX)
          err("undefined reference to 'main'");
      }
#line 1309 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 1318 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 1403 "micko.tab.c" /* yacc.c:1646  */
    break;
